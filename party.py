...
def is_mel(name, email):
    ...
    True
    >>> is_mel('Mel Melitpolski', 'Jello@jello.com')
    True
    >>> is_mel('John', 'mel@ubermelon.com')
    True
...
def most_and_least_common_type(treats):
    ...
    (None, None)
    >>> most_and_least_common_type([{'type': 'dessert'}, {'type': 'dessert'}, {'type': 'drink'}, {'type': 'drink'}, {'type': 'chocolate'}])
    ('dessert', 'chocolate')
